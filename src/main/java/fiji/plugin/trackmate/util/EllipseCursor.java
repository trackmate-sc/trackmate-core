...
public final class EllipseCursor< T > extends AbstractNeighborhoodCursor< T >
{
	...
	public void fwd()
	{
		...
		case INITIALIZED:
			...
			TMUtils.getXYEllipseBounds( ( int ) neighborhood.span[ 0 ], ( int ) neighborhood.span[ 1 ], rxs );
		...
		case INCREMENT_Y:
			...
			position[ 1 ] = -position[ 1 ] + 1; // y should be negative (coming
												// from mirroring or init = 0)
