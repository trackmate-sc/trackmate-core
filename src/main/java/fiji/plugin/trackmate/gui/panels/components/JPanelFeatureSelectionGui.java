...
import static fiji.plugin.trackmate.gui.GuiConstants.ICON_ADD;
import static fiji.plugin.trackmate.gui.GuiConstants.ICON_REMOVE;
		...
		try {
			...
			this.setLayout(layout);
			{
				...
				jPanelButtons.setLayout(null);
				{
					...
					jButtonRemove.setIcon( ICON_REMOVE );
